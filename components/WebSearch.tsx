...
const WebSearch: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold tracking-tight text-white">Web Search (Grounded)</h2>
        <p className="mt-1 text-sm text-gray-400">Ask questions about recent events to get up-to-date answers from Gemini, grounded in Google Search.</p>
      </div>
